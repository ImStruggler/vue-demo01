...
.index-board-car .index-board-item-inner{
  background: url(../assets/images/timg_23.png) no-repeat;
}
.index-board-loud .index-board-item-inner{
  background: url(../assets/images/timg_05.png) no-repeat;
}
.index-board-earth .index-board-item-inner{
  background: url(../assets/images/timg_15.png) no-repeat;
}
.index-board-hill .index-board-item-inner{
  background: url(../assets/images/timg_13.png) no-repeat;
}
.index-board-item h2 {
  font-size: 18px;
  font-weight: bold;
