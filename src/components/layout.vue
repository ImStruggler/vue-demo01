<template>
  <div @click="resetComponent">
    <div class="app-head">
      <div class="app-head-inner head-logo">
        <router-link :to = "{path: '/'}">
...
/*html display-role reset for older browser*/
...
body{
  background: #f0f2f5;
  font-family: "Helvetica Neue",Helvetica,Arial,"Hiragino Sans GB W3","Microsoft Yahei UI","Microsoft Yahei","WenQuanYi Micro Hei",sans-serif;
  font-size: 14px;
  color: #444;
